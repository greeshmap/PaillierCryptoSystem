 ...
 * EUROCRYPT'99. URL: <a
 * href="http://www.gemplus.com/smart/rd/publications/pdf/Pai99pai.pdf"
 * >http://www.gemplus.com/smart/rd/publications/pdf/Pai99pai.pdf</a><br>
 * 
 * [2] Paillier cryptosystem from Wikipedia. URL: <a
 * href="http://en.wikipedia.org/wiki/Paillier_cryptosystem"
 * >http://en.wikipedia.org/wiki/Paillier_cryptosystem</a>
 * 
...
public class Paillier {
	...
	/**
	 * Constructs an instance of the Paillier cryptosystem with "bitLengthVal" bits of
	 * modulus and at least 1-2^(-64) certainty of primes generation.
	 */
	public Paillier(int bitLengthVal) {
		KeyGeneration(bitLengthVal, 64);
	}
	...
	// public BigInteger DecryptionGetCipher(BigInteger c) {
	// BigInteger u = g.modPow(lambda, nsquare).subtract(BigInteger.ONE)
	// .divide(n).modInverse(n);
	// return c.modPow(lambda, nsquare).subtract(BigInteger.ONE).divide(n)
	// .multiply(u).mod(nsquare);
	// }
